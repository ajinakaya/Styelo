        ...
        <div className="mb-16">
          ...
          <div className="w-full h-96 bg-gray-200 rounded-lg overflow-hidden shadow-md">
            <iframe
              ...
              title="Styelo Location - Suryabinayak, Bhaktapur"
            />
          </div>
          <p className="text-center text-gray-600 mt-4">
            Visit our showroom at Suryabinayak, Bhaktapur to explore our complete collection of premium furniture and decor items.
          </p>
        </div>
        ...
        <div className="bg-gray-50 p-8 rounded-lg">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              ...
              <p className="text-gray-600">info@styelo.com</p>
              <p className="text-gray-600">support@styelo.com</p>
            </div>
